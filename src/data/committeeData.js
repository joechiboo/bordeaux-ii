...
export const committeeData = [
	{
		...
		contents: [
			...
			},
			{
				title: '當選委員名單',
				details: [
					{ key: 'A 棟(A3-15F)', attendance: '10111111111111111111110', value: '簡O燕' },
					{ key: 'A 棟(A5-12F)', attendance: '1111111111111111000----', value: '許O書' },
					{ key: 'B 棟(B1-04F)', attendance: '1111111111111111000----', value: '郭O銘' },
					{ key: 'B 棟(B3-09F)', attendance: '01111100001110011110011', value: '宋O翊' },
					{ key: 'C 棟(C2-08F)', attendance: '11011111111111011111111', value: '張O榮' },
					{ key: 'C 棟(C5-05F)', attendance: '1111111111111111000----', value: '鄧O芳' },
					{ key: 'D 棟(D3-09F)', attendance: '11111111110111001101111', value: '楊O華' },
					{ key: 'D 棟(D5-05F)', attendance: '11111101111111101110111', value: '褚O聲' },
					{ key: 'E 棟(E6-12F)', attendance: '11111010010001001------', value: '游O順(辭)' },
					{ key: 'E 棟(E7-15F)', attendance: '------------------11111', value: '周佑霖' },
					{ key: 'E 棟(E6-09F)', attendance: '1111111111111111000----', value: '楊O峰' },
					{ key: 'F 棟(F6-04F)', attendance: '11111111111111111110111', value: '林O君' },
					{ key: 'F 棟(F5-04F)', attendance: '11111100010001001------', value: '陳O宏(辭)' },
					{ key: 'G 棟(G6-04F)', attendance: '10110010000011011110111', value: '李O傑' },
					{ key: 'G 棟(G2-07F)', attendance: '11111111111111111101111', value: '李O鳳' },
					{ key: 'H 棟(H5-07F)', attendance: '11111111111111101111111', value: '呂O真' },
					{ key: 'H 棟(H6-05F)', attendance: '11111111110000001111111', value: '張O麗' },
					{ key: '店面(S1-01F)', attendance: '10000000000000000010110', value: '彭O思' },
				],
			},
		],
	},
