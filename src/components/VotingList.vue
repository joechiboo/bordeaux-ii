	...
	<div class="voting-list-container">
		...
		<div class="voting-content">
			...
			<div v-else class="voting-grid">
				<div v-for="voting in filteredVotings" :key="voting.id" class="voting-card" @click="goToVoting(voting.id)">
					...
					<div class="voting-info">
						<div class="info-item">
							...
							<span class="info-text"> {{ formatDate(voting.start_date) }} - {{ formatDate(voting.end_date) }} </span>
						</div>
						<div class="info-item">
							<span class="info-icon">👥</span>
					...
					<div class="voting-progress">
						<div class="progress-bar">
							<div class="progress-fill" :style="{ width: getProgressWidth(voting) + '%' }"></div>
						</div>
						<span class="progress-text"> 參與率: {{ getProgressWidth(voting) }}% </span>
					</div>
