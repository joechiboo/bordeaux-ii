		...
		data() {
			return {
				...
				committees: [
					...
					{
						version: '第二屆管理委員會',
						totalMeetings: 1, // 設定總會議次數 // 目前到5/7
						contents: [
							{
								title: '委員選舉結果',
								details: [
							...
							},
							{
								title: '當選委員名單',
								details: [
									{ key: 'A 棟(A3-15F)', value: '簡O燕', attendance: [true] },
									{ key: 'A 棟(A5-12F)', value: '許O書', attendance: [true] },
									{ key: 'B 棟(B1-04F)', value: '郭O銘', attendance: [true] },
									{ key: 'B 棟(B3-09F)', value: '宋O翊', attendance: [false] },
									{ key: 'C 棟(C2-08F)', value: '張O榮', attendance: [true] },
									{ key: 'C 棟(C5-05F)', value: '鄧O芳', attendance: [true] },
									{ key: 'D 棟(D3-09F)', value: '楊O華', attendance: [true] },
									{ key: 'D 棟(D5-05F)', value: '褚O聲', attendance: [true] },
									{ key: 'E 棟(E6-12F)', value: '游O順', attendance: [true] },
									{ key: 'E 棟(E6-09F)', value: '楊O峰', attendance: [true] },
									{ key: 'F 棟(F6-04F)', value: '林O君', attendance: [true] },
									{ key: 'F 棟(F5-04F)', value: '陳O宏', attendance: [true] },
									{ key: 'G 棟(G6-04F)', value: '李O傑', attendance: [true] },
									{ key: 'G 棟(G2-07F)', value: '李O鳳', attendance: [true] },
									{ key: 'H 棟(H5-07F)', value: '呂O真', attendance: [true] },
									{ key: 'H 棟(H6-05F)', value: '張O麗', attendance: [true] },
									{ key: '店面(S1-01F)', value: '彭O恩', attendance: [true] },
								],
							},
						],
					},
